    ...
    <AnimatedPage>
      ...
      <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2 xl:grid-cols-3">
        {reports.map(({ icon: Icon, title, desc }) => (
          <button
            key={title}
            className="rounded-card border border-hairline bg-surface p-[18px] text-left transition-all hover:-translate-y-px hover:border-gold focus-visible:border-gold focus-visible:outline-none"
          >
            <Icon size={16} className="mb-2.5 text-gold" strokeWidth={1.8} />
